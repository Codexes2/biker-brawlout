...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Biker Brawlout Team'],
			['Xiang', 				'xiang',			'Director/Artist/Brainrot', 							'https://twitter.com/x2xiang', 			'FFFFFF'],
			['Codexes',				'codexes', 			'Programmer/Charter',									'https://twitter.com/Codexes1', 		'FA6D14'],
			['camoREX',				'camorex',			'Composer',												'https://twitter.com/camoREXXX',		'26522E'],
			[''],
			[''],
			['Psych Engine Team'],
